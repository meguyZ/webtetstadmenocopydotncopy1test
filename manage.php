...
<?php 
  if(isset($_POST['addannounce'])){
    ...
    $addanounceSQL = "INSERT INTO `allthink`(`ttopic`, `tcontent`, `twhowrite`, `twhonickname`, `tcansee`, `timg`, `tcate`) VALUES ('".$topic."' , '".$content."' , '".$who."', '".$who."' , '".$see."' , '".$image."' , '".$cate."')";
    $addanounceSQL_query = mysqli_query($conn,$addanounceSQL);

    $title = 'สร้าง ANNOUNCE เรียบร้อยแล้ว'; $text = 'กำลังเชื่อมต่อข้อมูล...'; $delay = '3000'; $link = 'manage.php';
...
<?php 
  if(isset($_POST['deleteuser'])){
    ...
    $title = 'ลบสำเร็จ'; $text = 'กำลังเชื่อมต่อข้อมูล...'; $delay = '3000'; $link = 'manage.php';
    msg_success($title,$text,$delay,$link);
  }
?>
...
<?php 
  if(isset($_POST['changebanner'])){
    ...
    $title = 'แก้ไข banner เรียบร้อยแล้ว'; $text = 'กำลังเชื่อมต่อข้อมูล...'; $delay = '3000'; $link = 'manage.php';
    msg_success($title,$text,$delay,$link);
  }
?>